...
entities.game.GameScene.load = function(world) {
    ...
    var arch4 = world.createArchetype(game.RepeatingBackground, game.Scroller, this.Component, ut.Core2D.Sprite2DRenderer, ut.Core2D.TransformLocalPosition, ut.Core2D.TransformLocalRotation, ut.Core2D.TransformLocalScale, ut.Core2D.TransformNode, ut.HitBox2D.RectHitBox2D, ut.layers.Default)
    ...
    c11.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/Day/bg_day');
    ...
    c48.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/Game/ground');
    ...
    var c49 = new ut.HitBox2D.RectHitBox2D();
    ...
    var c50 = new game.Scroller();
    c50.value = 1;
    world.setComponentData(e7, c50);
    var c51 = new game.RepeatingBackground();
    c51.threshold = -3.36;
    c51.distance = 6.72;
...
entities.game.Pipes.load = function(world) {
    ...
    var arch1 = world.createArchetype(game.AutoDestroy, game.ScorePoint, game.Spacing, this.Component, ut.Core2D.LayerSorting, ut.Core2D.SortingGroup, ut.Core2D.TransformLocalPosition, ut.Core2D.TransformLocalRotation, ut.Core2D.TransformLocalScale, ut.Core2D.TransformNode, ut.layers.Default)
    var e1 = world.createEntity(arch1);
    ...
    c16.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/Day/pipe_brown_top');
    ...
    c23.sprite = ut.EntityLookupCache.getByName(world, 'assets/sprites/Day/pipe_brown_bottom');
